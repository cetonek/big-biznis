...
import com.github.cetonek.bigbiznis.FileReader
import com.github.cetonek.bigbiznis.TestConfiguration
...
class CNBClientTest {
    ...
    fun `client fetches and parses exchange rates for given day`() {
        ...
        mockRestServer
                ...
                .andRespond(
                        withSuccess(fileReader.readMockAsString("cnb/test_exchange_rates.xml"),
    ...
    fun `client fetches and parses average salaries for given date range`() {
        ...
        mockRestServer
                ...
                .andRespond(
                        withSuccess(
                                fileReader.readMockAsString("cnb/test_average_salaries.txt"),
    ...
    fun `client fetches and parses average unemployment rates for given date range`() {
        ...
        mockRestServer
                .expect(requestTo(url))
                .andRespond(
                        withSuccess(fileReader.readMockAsString("cnb/test_monthly_unemployment.txt"),
                                MediaType.TEXT_PLAIN)
                )
    ...
    fun `client fetches and parses quarterly real gdp for given date range`() {
        ...
        mockRestServer
                .expect(requestTo(url))
                .andRespond(
                        withSuccess(fileReader.readMockAsString("cnb/test_real_quarterly_gdp_2010_prices.txt"),
                                MediaType.TEXT_PLAIN)
                )
